...
- (void)applyLayoutAttributes:(UICollectionViewLayoutAttributes *)layoutAttributes {
    if (layoutAttributes.indexPath.row == 0) {
        layoutAttributes.frame = CGRectMake(0,0,210,210);
    }
    else if (layoutAttributes.indexPath.row == 1){
        
        layoutAttributes.frame = CGRectMake(220,0,100,100);
    }
    else if (layoutAttributes.indexPath.row == 2){
        
        layoutAttributes.frame = CGRectMake(220,110,100,100);
    }
    else if (layoutAttributes.indexPath.row == 5){
        
        layoutAttributes.frame = CGRectMake(0,220,100,100);
    }
    else if (layoutAttributes.indexPath.row == 4){
        
        layoutAttributes.frame = CGRectMake(110,220,100,100);
    }
    else if (layoutAttributes.indexPath.row == 3){
        layoutAttributes.frame = CGRectMake(220,220,100,100);
    }
